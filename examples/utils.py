...
async def run_pair(
    ...
    async with EchoServer(True, server_ssl, sndbuf_size) as server_port:
        async with EchoClient(True, server_port, duration, payload, client_ssl, sndbuf_size) as client:
