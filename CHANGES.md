...
- aiofastnet now works with uv standalone python; ssl layer is slightly slower than when regular python is used, but it is still faster than ssl layer in
  asyncio and uvloop.
...
- Contains optimized versions of create_connection, create_server, start_tls and sendfile.
